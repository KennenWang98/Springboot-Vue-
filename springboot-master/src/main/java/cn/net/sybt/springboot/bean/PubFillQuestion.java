...
public class PubFillQuestion implements PubQuestionInterface {
    ...
    public PubFillQuestion() {
    }

    @Override
    public String toString() {
        return "PubFillQuestion{" +
                "quesId=" + quesId +
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PubFillQuestion)) return false;
        PubFillQuestion that = (PubFillQuestion) o;
