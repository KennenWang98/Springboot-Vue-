...
public class PubMatchQuestion implements PubQuestionInterface {
    ...
    public PubMatchQuestion() {
    }

    @Override
    public String toString() {
        return "PubMatchQuestions{" +
                "quesId=" + quesId +
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PubMatchQuestion)) return false;
        PubMatchQuestion that = (PubMatchQuestion) o;
